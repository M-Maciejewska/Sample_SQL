...
First, write a query that returns the project details along with the details of the employee assigned to each project (identified by the current_project_id in the employees table) 
...
any employees assigned to them (i.e., only include projects with IDs (id) that are present in the employees table under the current_project_id column).
